...
export default function TreeNode({ id, avgRent, color, isSelected, hasTestPoint, isSmall }) {
    ...
    return <div className={classNames("tree-node relative shadow-2xl flex items-center", {
        'ring-8': isSelected,
