    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Wenn die KI <i>alle möglichen</i> Unterteilungen von links nach rechts
          und von oben nach unten getestet hat, wählt sie die <i>beste</i>{" "}
          Unterteilung.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Am besten ist die Unterteilung, bei der die Unterschiede zwischen den
          echten Mietpreisen und der durchschnittlichen Miete in den Bereichen
          am kleinsten sind.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Die entsprechende Unterteilung resultiert in einer Linie auf der Karte
          und einer Verzweigung im Entscheidungsbaum.
        </div>
      </Stack>
      <Link to="/final">
        <div
