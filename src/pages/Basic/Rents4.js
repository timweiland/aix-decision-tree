    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Die Bereiche können nach dem obigen Verfahren in weitere Unterbereiche
          unterteilt werden. Auf diese Weise entsteht Schritt für Schritt eine
          immer genauere Unterteilung der Karte. Der zugehörige
          Entscheidungsbaum ist zunehmend verzweigt.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Mit jeder neuen Unterteilung wird der Unterschied zwischen den echten
          Mieten und der durchschnittlichen Miete in den jeweiligen Bereichen
          kleiner, sodass die Schätzungen der KI am Ende sehr genau werden.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Die Schätzungen der KI entsprechen den durchschnittlichen Mieten in
