    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Das Beispiel der Mietpreise ist so gewählt, dass Menschen es
          nachvollziehen und ihren eigenen Entscheidungsbaum erstellen können.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Eine KI kann nach dem hier beschriebenen Prinzip Entscheidungsbäume
          auch für viel größere Datenmengen berechnen.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Gleichzeitig bleiben die Ergebnisse von Entscheidungsbäumen auch bei
          großen Datenmengen nachvollziehbar. Das macht sie zu einem sehr
          beliebten Algorithmus.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
