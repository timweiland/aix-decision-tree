    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Um die Mieten in den verschiedenen Stadtteilen gut zu schätzen, muss
          die KI herausfinden, wo auf der Karte die Mieten möglichst{" "}
          <i>ähnlich</i> sind.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Diese Bereiche muss sie von Bereichen mit anderen Mietpreisen{" "}
          <i>unterscheiden</i>.
        </div>
      </Stack>
      <Link to="/final">
