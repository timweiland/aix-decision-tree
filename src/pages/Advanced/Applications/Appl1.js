    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Weil sie nachvollziehbar sind, sind Entscheidungsbäume ein sehr
          beliebter Algorithmus.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          In der Medizin können sie Ärzt_innen bei der Diagnose von Brustkrebs
          unterstützen. Anhand von Aufnahmen von Brustgewebe und Merkmalen wie
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          <div class="text-3xl text-black font-normal leading-relaxed">
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Für die Ärzt_innen und Patient_innen ist es wichtig zu wissen, wieso
          die KI einen Tumor als gutartig oder bösartig eingestuft hat.
        </div>
      </Stack>
