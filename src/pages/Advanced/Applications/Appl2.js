    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Banken können Entscheidungsbäume nutzen, um einzuschätzen, ob eine
          Person einen Kredit zurückzahlen wird oder nicht. Entsprechend können
          sie den Kredit bewilligen oder verweigern.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Sollte die KI zu dem Ergebnis kommen, dass der Kredit vermutlich nicht
          zurückgezahlt werden wird, ist es für die Bank und den_die
          Antragsteller_in wichtig zu wissen, wieso.
        </div>
      </Stack>
