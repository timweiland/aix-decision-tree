    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Außerdem enthält das Beispiel der Mieten in Tübingen nur knapp 160
          Datenpunkte. Das ist sehr wenig.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Datensätze, welche mehrere Hundert bis Tausend Datenpunkte enthalten,
          sind in realen Anwendungen keine Seltenheit.
        </div>
      </Stack>
