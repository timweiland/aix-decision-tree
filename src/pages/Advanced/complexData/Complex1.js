    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Im Beispiel der Mieten in Tübingen hat jeder Datenpunkt zwei Merkmale:
          Längengrad und Breitengrad, zusammen ergeben sie eine bestimmte
          Position auf der Karte.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          In vielen Fällen haben Daten deutlich mehr als zwei Merkmale. Fische
