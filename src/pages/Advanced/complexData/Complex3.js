    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          ...
          der anhand der gerade genannten Merkmale verschiedene Fischarten
          voneinander unterscheiden kann. Auch wenn der Datensatz 1000
          Datenpunkte oder mehr enthält.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Wir Menschen würden deutlich länger brauchen und könnten schnell den
          Überblick verlieren.
        </div>
      </Stack>
