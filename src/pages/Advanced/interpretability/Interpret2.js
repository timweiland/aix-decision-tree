    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Jede Unterteilung geschieht anhand eines bestimmten <i>Werts</i>{" "}
          dieses Merkmals: Der eine Teil der Daten hat bei diesem Merkmal{" "}
          <i>kleinere</i> Werte, der andere Teil hat <i>größere</i> Werte.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Auf der Karte Tübingens hat jede Trennungslinie einen bestimmten
          Längen- oder Breitengrad. Die Datenpunkte liegen entweder weiter{" "}
          <i>links</i> oder <i>rechts</i>, bzw. weiter <i>oberhalb</i> oder{" "}
          <i>unterhalb</i> der Trennungslinie.
        </div>
      </Stack>
