    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Bei Datenpunkten mit mehreren Merkmalen lässt sich die Unterteilung
          nicht mehr anhand einer Karte nachvollziehen. Hier hilft der
          Entscheidungsbaum weiter.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Jede Verzweigung im Entscheidungsbaum enthält das Merkmal und seinen
          Wert, anhand dessen in zwei Gruppen unterteilt wurde.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Wenn man den Entscheidungsbaum vom Beginn bis zu den Enden liest, kann
          man für jede Gruppe nachvollziehen, hinsichtlich welcher Merkmale die
          Datenpunkte in dieser Gruppe <i>ähnlich</i> sind.
        </div>
        <div>
          <img
            style={{ height: "54vh", marginLeft: "-8.8vw", marginTop: "-6vh" }}
            src={fish_2}
            alt="fish_2"
          />
        </div>
