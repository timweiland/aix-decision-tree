    ...
    <div className="column-container">
      ...
      >
        ...
        <div class="text-3xl text-black font-normal leading-relaxed">
          Jedes Mal, wenn die KI eine Linie in die Karte zeichnet, teilt sie die
          Datenpunkte anhand des Längengrades (mit einer waagerechten Linie)
          oder des Breitengrades (mit einer senkrechten Linie) auf.
        </div>
        <div class="text-3xl text-black font-normal leading-relaxed">
          Längen- und Breitengrad sind die sogenannten <i>Merkmale</i> eines
          jeden Datenpunkts. Zusammen ergeben sie eine Position auf der Karte.
        </div>
      </Stack>
