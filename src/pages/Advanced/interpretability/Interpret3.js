...
export default function Interpret3() {  
    return (
        ...
        >
            ...
            class="text-3xl text-black font-normal leading-relaxed"
            >
               Das Vorgehen der KI bleibt jedoch auch bei einer größeren Anzahl von Merkmalen unverändert. In jedem Schritt unterteilt sie die Daten anhand <i>eines bestimmten</i> Werts von genau <i>einem</i> Merkmal, egal wie viele Merkmale es gibt.
            </div>
            <div
            class="text-3xl text-black font-normal leading-relaxed"
            >
               Dafür probiert sie erst <i>alle</i> Merkmale mit <i>verschiedenen</i> Werten durch. Schließlich wählt sie das Merkmal mit dem Wert, das zur besten Unterteilung führt (siehe den Algorithmus in <i>Grundlagen</i>).
            </div>
            </Stack>
