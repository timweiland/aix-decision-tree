...
function Complex() {
  return (
    <div className="column-container">
            ...
            class="text-3xl text-black font-normal leading-relaxed"
            >
               Eine KI kann in sehr kurzer Zeit einen Entscheidungsbaum berechnen, der anhand dieser Merkmale verschiedene Fischarten voneinander unterscheiden kann. Auch wenn der Datensatz 5000 Datenpunkte oder mehr enthält. Wir Menschen würden deutlich länger brauchen und könnten schnell den Überblick verlieren.
            </div>
            </Stack>
            {/*<Link to="/final">
                <div
